...
if (_target getVariable ["Reviving", objNull] isEqualTo player) exitWith {[ localize "STR_Medic_AlreadyReviving",true,"fast"] call life_fnc_notification_system;};
...
if (_target getVariable ["Revive", false]) exitWith {[ localize "STR_Medic_RevivedRespawned",false,"fast"] call life_fnc_notification_system; life_action_inUse = false;};
