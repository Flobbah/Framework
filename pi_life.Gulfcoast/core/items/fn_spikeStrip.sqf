...
*/
private ["_spikeStrip"];
if (!isNil "life_action_spikeStripPickup") exitWith {[ localize "STR_ISTR_SpikesDeployment",true,"fast"] call life_fnc_notification_system};    // avoid conflicts with addactions allowing duplication.
