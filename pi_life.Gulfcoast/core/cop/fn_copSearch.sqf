...
if (!alive _civ || player distance _civ > 5) exitWith {[ format [localize "STR_Cop_CouldntSearch",_civ getVariable ["realname",name _civ]],true,"fast"] call life_fnc_notification_system};
