...
if (getPlayerUID player isEqualTo (group player getVariable "gang_owner")) exitWith {[ localize "STR_GNOTF_LeaderLeave",true,"fast"] call life_fnc_notification_system};
