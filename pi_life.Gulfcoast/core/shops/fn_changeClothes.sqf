...
if (_selection isEqualTo -1) exitWith {[ localize "STR_Shop_NoSelection",true,"fast"] call life_fnc_notification_system;};
if (isNull _control) exitWith {[ localize "STR_Shop_NoDisplay",true,"fast"] call life_fnc_notification_system};
